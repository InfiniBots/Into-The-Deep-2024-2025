...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1125.4467851132993; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1211.1437261483227; // x position of the perpendicular encoder (in tick units)
    }
