...
public class FollowerConstants {
    ...
    private static double xMovement = 70.8025;
    private static double yMovement = 60.6298;
    ...
    public static double mass = 12.292;
    ...
    public static double forwardZeroPowerAcceleration = -103.0881;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -147.3891;
